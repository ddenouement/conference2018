...
try {
                ...
                if (profile.getConferences().contains(
                        websafeConferenceKey)) {
 ...
 /**
    ...
    public Collection<Conference> getConferencesToAttend(final User user)
        ...
        List<String> keyStringsToAttend =  profile.getConferences();; // change this
...
return ofy().load().keys(keysToAttend).values();
	...
	/*******************************************************************/
	 @ApiMethod(
	            name = "getConferencesCreated", path = "getConferencesCreated",
	            httpMethod = HttpMethod.POST
	    )
